...
-----END CERTIFICATE-----"""
    ...
    @Test
    fun `given an alternative subject name, then it validates with it`() {
        // certificate with subject name coronatester.nl and alt name giorgos.nl
        val cert = """-----BEGIN CERTIFICATE-----
MIIDlTCCAn2gAwIBAgIUSLQut4HDPM/yQCqbKQIoQm3zDvQwDQYJKoZIhvcNAQEL
...
Fw0yMTA3MTUwOTMxNDNaFw0yMTA4MTQwOTMxNDNaMFoxKzApBgNVBAMMIlN0YWF0
...

+5STglRz/Ev1
-----END CERTIFICATE-----
"""
        val payload = ""
        val signature = ""
