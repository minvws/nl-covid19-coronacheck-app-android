...
package nl.rijksoverheid.ctr.util
...
import nl.rijksoverheid.ctr.items.ui.BulletPointSpan

object HtmlHelper {

    fun buildSpannableFromHtml(
        html: String,
        context: Context
    ): SpannableStringBuilder {
        val spannableBuilder = fromHtml(html)
        val bulletSpans = spannableBuilder.getSpans<BulletSpan>()
