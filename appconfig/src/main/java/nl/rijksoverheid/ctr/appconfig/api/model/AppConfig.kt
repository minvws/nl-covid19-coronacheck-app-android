...
data class AppConfig(
    ...
    @Json(name = "requireUpdateBefore") val requireUpdateBefore: Int = 0,
    @Json(name = "temporarilyDisabled") val temporarilyDisabled: Boolean = false,
    @Json(name = "recoveryEventValidity") val recoveryEventValidity: Int = 0,
    @Json(name = "testEventValidity") val testEventValidity: Int = 0,
    @Json(name = "domesticCredentialValidity") val domesticCredentialValidity: Int = 0,
    @Json(name = "credentialRenewalDays") val credentialRenewalDays: Int = 0,
    ...
    @Json(name = "euLaunchDate") val euLaunchDate: String = "0",
