...
class DashboardGreenCardAdapterItemUtilImplTest : AutoCloseKoinTest() {
    ...
    fun `domesticVaccination that expires in 3 years`() {
        ...
        val greenCard =
            greenCard(GreenCardType.Eu, listOf(OriginType.Vaccination), expirationTime)
        myOverViewGreenCardAdapterUtil.setContent(
            viewBinding, listOf(
                AdapterCard(
                    greenCard, listOf(
        ...
        (assertEquals(View.GONE, viewBinding.expiresIn.visibility)).toString()
    }
    ...
    fun `domesticVaccinationFuture that has a validity of more than 3 years`() {
        ...
        assertEquals(
            ...
            (viewBinding.expiresIn.text).toString()
        )
    ...
    fun domesticVaccinationAssessment() {
        ...
        val greenCard = greenCard(GreenCardType.Eu, listOf(OriginType.VaccinationAssessment))
        myOverViewGreenCardAdapterUtil.setContent(
            viewBinding, listOf(
                AdapterCard(
                    greenCard, listOf(
