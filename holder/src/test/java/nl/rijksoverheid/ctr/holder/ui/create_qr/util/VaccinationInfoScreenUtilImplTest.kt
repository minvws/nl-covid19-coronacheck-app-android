...
class VaccinationInfoScreenUtilImplTest : AutoCloseKoinTest() {
    ...
    fun `get correct vaccination screen info`() {
        ...
        assertEquals(
            "Deze gegevens van je vaccinatie zijn opgehaald bij GGD:<br/><br/>Naam: <b>Surname</b><br/>Geboortedatum: <b>01-08-1982</b><br/><br/>Ziekteverwekker: <b>COVID-19</b><br/>Vaccin: <b>Pfizer (Comirnaty)</b><br/>Vaccin type: <b>type</b><br/>Producent: <b></b><br/>Doses: <b>1 van 2</b><br/>Vaccinatiedatum: <b>1 augustus 2021</b><br/>Gevaccineerd in: <b>NLD</b><br/>Uniek vaccinatienummer: <b>unique</b><br/>",
