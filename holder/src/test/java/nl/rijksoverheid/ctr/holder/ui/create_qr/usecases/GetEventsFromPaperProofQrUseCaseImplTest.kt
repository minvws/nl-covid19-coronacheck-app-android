...
class GetEventsFromPaperProofQrUseCaseImplTest {

    private val mobileCoreWrapper: MobileCoreWrapper = mockk()
    ...
    fun `vaccination should be parsed from qr`() {
        ...
        every { mobileCoreWrapper.readEuropeanCredential(vaccinationQr.toByteArray()) } returns credential
    ...
    fun `recovery should be parsed from qr`() {
        ...
        every { mobileCoreWrapper.readEuropeanCredential(recoveryQr.toByteArray()) } returns credential
    ...
    fun `test should be parsed from qr`() {
        ...
        every { mobileCoreWrapper.readEuropeanCredential(testQr.toByteArray()) } returns credential
    ...
    fun `an invalid qr should parse to invalid qr result`() {
        ...
        every { mobileCoreWrapper.readEuropeanCredential(invalidQr.toByteArray()) } returns
                JSONObject("{}")
