...
interface LoginTypeUtil {
    ...
    @StringRes
    fun getCanceledDialogDescription(loginType: LoginType): Int
}
...
class LoginTypeUtilImpl: LoginTypeUtil {
    ...
    override fun getCanceledDialogDescription(loginType: LoginType): Int {
        return when (loginType) {
            LoginType.Max -> R.string.holder_authentication_popup_digid_message
            LoginType.Pap -> R.string.holder_authentication_popup_portal_message
        }
    }
}
