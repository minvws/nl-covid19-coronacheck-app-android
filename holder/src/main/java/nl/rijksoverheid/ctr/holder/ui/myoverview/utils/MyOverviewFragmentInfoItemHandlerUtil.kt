...
interface MyOverviewFragmentInfoItemHandlerUtil {
    fun handleButtonClick(myOverviewFragment: MyOverviewFragment,
                          infoItem: DashboardItem.InfoItem)

    fun handleDismiss(myOverviewFragment: MyOverviewFragment,
...
class MyOverviewFragmentInfoItemHandlerUtilImpl(
     ...
     */
    override fun handleButtonClick(myOverviewFragment: MyOverviewFragment,
                          infoItem: DashboardItem.InfoItem) {
        when (infoItem) {
                ...
                bottomSheetDialogUtil.present(
                    ...
                    BottomSheetData.TitleDescription(
                        ...
                        applyOnDescription = { htmlTextViewWidget ->
                            htmlTextViewWidget.setHtmlText(myOverviewFragment.getString(R.string.extended_domestic_recovery_green_card_bottomsheet_description), true)
                        }
                    )
                )
            }
            is DashboardItem.InfoItem.Dismissible.RecoveredDomesticRecovery -> {
                bottomSheetDialogUtil.present(
                    ...
                    BottomSheetData.TitleDescription(
                        ...
                        applyOnDescription = { htmlTextViewWidget ->
                            htmlTextViewWidget.setHtmlText(myOverviewFragment.getString(R.string.recovered_domestic_recovery_green_card_bottomsheet_description), true)
                        }
                    )
                )
            }
            is DashboardItem.InfoItem.Dismissible.RefreshedEuVaccinations -> {
                bottomSheetDialogUtil.present(
                    ...
                    BottomSheetData.TitleDescription(
                        ...
                        applyOnDescription = { htmlTextViewWidget ->
                            htmlTextViewWidget.setHtmlText(myOverviewFragment.getString(R.string.refreshed_eu_items_description), true)
                        }
                    )
                )
            }
     ...
     */
    override fun handleDismiss(myOverviewFragment: MyOverviewFragment,
                      infoCardItem: MyOverviewInfoCardItem,
                      infoItem: DashboardItem.InfoItem.Dismissible) {
