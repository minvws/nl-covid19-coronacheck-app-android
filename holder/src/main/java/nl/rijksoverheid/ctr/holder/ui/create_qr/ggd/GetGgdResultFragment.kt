package nl.rijksoverheid.ctr.holder.ui.create_qr.ggd
...
class GetGgdResultFragment : DigiDFragment(R.layout.fragment_get_vaccination) {
    ...
    private val getGgdResultViewModel: GetGgdResultViewModel by viewModel()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        getGgdResultViewModel.loading.observe(viewLifecycleOwner, EventObserver {
            (parentFragment?.parentFragment as HolderMainFragment).presentLoading(it)
        })
        ...
        digidViewModel.accessTokenLiveData.observe(viewLifecycleOwner, EventObserver {
            getGgdResultViewModel.getEvents(it)
        })
