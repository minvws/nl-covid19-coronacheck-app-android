...
sealed class VerificationCodeFragmentData(
    ...
    @StringRes val uniqueCodeNotValid: Int,
    ...
    object CommercialTest: VerificationCodeFragmentData(
        ...
        uniqueCodeNotValid = R.string.commercial_test_error_invalid_combination,
    ...
    object VisitorPass: VerificationCodeFragmentData(
        ...
        uniqueCodeInputHintScreenReader = R.string.visitorpass_token_input_placeholder_screenreader,
        noUniqueCodeEntered = R.string.visitorpass_token_error_empty_token,
        uniqueCodeNotValid = R.string.visitorpass_token_error_invalid_code,
