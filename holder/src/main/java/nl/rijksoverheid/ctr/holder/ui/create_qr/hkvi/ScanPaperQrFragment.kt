...
import nl.rijksoverheid.ctr.holder.databinding.FragmentScanPaperQrBinding
 ...
 *
 */
class ScanPaperQrFragment : Fragment(R.layout.fragment_scan_paper_qr) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        FragmentScanPaperQrBinding.bind(view).run {
