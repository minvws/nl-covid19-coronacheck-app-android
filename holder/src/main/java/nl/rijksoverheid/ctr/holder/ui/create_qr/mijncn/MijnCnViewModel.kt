 ...
 *
 */
class MijnCnViewModel(
    private val mijnCNAuthenticationRepository: MijnCNAuthenticationRepository,
    ...
    fun login(
        ...
        viewModelScope.launch {
            try {
                mijnCNAuthenticationRepository.authResponse(activityResultLauncher, authService)
            } catch (e: Exception) {
